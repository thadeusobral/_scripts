...
#	2. salvar outputs detalhados por algoritmo e AOGCM, bem como o ensamble final
#	3. inserir varias especies ao mesmo tempo
#	4. implementar multi-cores (usar todos os processadores) para rodar vario modelos em paralelo
